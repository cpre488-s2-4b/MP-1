...
HD_PWD='X:/CprE488/Labs/MP-1/quad_uav/quad_uav.runs/design_1_axi_ppm_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_ppm_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_ppm_0_3.tcl
